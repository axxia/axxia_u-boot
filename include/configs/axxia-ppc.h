...
#define GPREG_USB               (IO+0x00)
#define GPREG_MAC               (IO+0x04)
#define GPREG_PCI_SRIO_PHY_CTRL (IO+0x08)
#define GPREG_MISC              (IO+0x0c)
#define GPREG_AXIS_MDIO_MODE    (IO+0x10)
#define GPREG_LVL_IRQ_STATS     (IO+0x80)
#define GPREG_LVL_IRQ_MASK      (IO+0x84)
#define GPREG_LVL_IRQ_INV       (IO+0x88)
#define GPREG_LVL_IRQ_NOMASK    (IO+0x8c)
#define GPREG_EDG_IRQ_STATS     (IO+0x90)
#define GPREG_EDG_IRQ_MASK      (IO+0x94)
#define GPREG_EDG_IRQ_INV       (IO+0x98)
#define GPREG_EDG_IRQ_NOMASK    (IO+0x9c)
#define GPREG_EDG_IRQ_RAW       (IO+0x100)
#else
